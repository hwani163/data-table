...
var renderer = {
  ...
  draw: (args, cell) => {
    ...
    ctx.fillText(
      text,
      x + padX,
      y + chipH / 2 + glideDataGrid.getMiddleCenterBias(ctx, theme)
    );
    return true;
  },
  ...
  provideEditor: glideDataGridCells.DropdownCell.provideEditor,
  onPaste: (v, d) => ({
    ...d,
...
var renderer2 = {
  ...
  draw: (args, cell) => {
    ...
    for (let i = 0; i < actions.length; i++) {
      ...
      ctx.fillText(a.label, x + BTN_PAD, y + BTN_H / 2 + glideDataGrid.getMiddleCenterBias(ctx, font));
    }
    ctx.restore();
    return true;
  },
...
function buildDisplayCell(spec, value, row, editable, themeOverride) {
  switch (spec.kind) {
    ...
    case "toggle": {
      return {
        kind: glideDataGrid.GridCellKind.Boolean,
        data: Boolean(value),
        allowOverlay: false,
        readonly: !editable,
        themeOverride
...
function ToolPanel({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("div", { className: "border-b border-border bg-muted-shadcn/30 max-h-[220px] overflow-auto", children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: "flex flex-wrap gap-1.5 px-3 py-2", children: columnState.map((s) => {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(lucideReact.GripVertical, { size: 11, className: "text-muted-shadcn-foreground shrink-0" }),
          /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              type: "button",
              ...
              children: s.visible && /* @__PURE__ */ jsxRuntime.jsx(lucideReact.Check, { size: 9, className: "text-primary-foreground", strokeWidth: 3 })
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsx(
            "span",
...
function HeaderMenu({ menu, enableSort, labels, menuRef, onSort, onHide }) {
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        enableSort && /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
          /* @__PURE__ */ jsxRuntime.jsx(MenuItem, { icon: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ArrowUp, { size: 12 }), label: labels.sortAsc, onClick: () => onSort("asc") }),
          /* @__PURE__ */ jsxRuntime.jsx(
            MenuItem,
            {
              icon: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.ArrowDown, { size: 12 }),
              label: labels.sortDesc,
              onClick: () => onSort("desc")
            }
          ),
          /* @__PURE__ */ jsxRuntime.jsx(MenuItem, { icon: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.X, { size: 12 }), label: labels.sortClear, onClick: () => onSort(null) }),
          /* @__PURE__ */ jsxRuntime.jsx("div", { className: "h-px bg-border my-1" })
        ] }),
        /* @__PURE__ */ jsxRuntime.jsx(MenuItem, { icon: /* @__PURE__ */ jsxRuntime.jsx(lucideReact.EyeOff, { size: 12 }), label: labels.hide, onClick: onHide })
      ]
    }
  );
}
function MenuItem({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsx("span", { className: "text-slate-500", children: icon }),
...
function StatusBar({ rowCount, visibleCount, totalCount, sort, titleFor, labels }) {
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "px-4 py-2 border-t border-border bg-muted-shadcn/40 text-[11px] text-muted-shadcn-foreground flex items-center justify-between", children: [
    ...
    sort && /* @__PURE__ */ jsxRuntime.jsxs("div", { children: [
      labels.sort,
      ":",
      " ",
...
function DataTable({
  ...
  const setColumnState = react.useCallback(
    (updater) => {
      if (controlledState) {
  ...
  const visibleResolved = react.useMemo(
  ...
  const selectOptionsByCol = react.useMemo(() => {
    const m = /* @__PURE__ */ new Map();
  ...
  const getCellContent = react.useCallback(
    ([col, row]) => {
      ...
      if (typeof value === "number") {
        return {
          kind: glideDataGrid.GridCellKind.Number,
          data: value,
  ...
  const onColumnResizeEnd = react.useCallback(
    (column, newSize) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        enableToolPanel && /* @__PURE__ */ jsxRuntime.jsx(
          ToolPanel,
          {
            columnState,
            defById,
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "flex flex-1 overflow-hidden relative", children: [
          /* @__PURE__ */ jsxRuntime.jsxs("div", { ref: containerRef, className: "flex-1 overflow-hidden relative", children: [
            ...
            !loading && sortedData.length === 0 && emptyMessage != null && /* @__PURE__ */ jsxRuntime.jsx("div", { style: OVERLAY_STYLE, children: emptyMessage }),
            loading && /* @__PURE__ */ jsxRuntime.jsx("div", { style: { ...OVERLAY_STYLE, pointerEvents: "auto" }, children: /* @__PURE__ */ jsxRuntime.jsx("span", { style: { opacity: 0.6, fontSize: 13 }, children: labels.loading }) })
          ] }),
          headerMenu && enableHeaderMenu && /* @__PURE__ */ jsxRuntime.jsx(
            HeaderMenu,
            {
              menu: headerMenu,
              enableSort,
...
exports.default = data_table_default;
